function [ek,d]=middleshellek_p(am,bm,middle_layers,t,dyhm,jdzb,jdzb1,dybh)
% dyhm: 单元编号
% jdzb: 单元上层节点的物理坐标
% jdzb1: 单元下层节点的物理坐标
% dybh: en
...
E1p=middle_layers(1,1);E2p=middle_layers(1,2);
Niu1p=middle_layers(1,4);Niu2p=middle_layers(1,5);
Gp=middle_layers(1,3);

d =[E1p/(1-Niu1p*Niu2p) Niu2p*E1p/(1-Niu1p*Niu2p) 0 0 0;
  Niu2p*E1p/(1-Niu1p*Niu2p) E2p/(1-Niu1p*Niu2p) 0 0 0;
  0 0 Gp 0 0;
  0 0 0 Gp/1.2 0;
  0 0 0 0 Gp/1.2];
d1 =[E1p/(1-Niu1p*Niu2p) Niu2p*E1p/(1-Niu1p*Niu2p) 0 0 0;
  Niu2p*E1p/(1-Niu1p*Niu2p) E2p/(1-Niu1p*Niu2p) 0 0 0;
  0 0 Gp 0 0;
  0 0 0 Gp 0;
  0 0 0 0 Gp];
