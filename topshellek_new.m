function [ek,theta,xv2i,xv1i,xv3i,zmtemp,v3i,d,jtemp]=topshellek_new(~,~,top_layers,H_total,dyhm,jdzb,jdzb1,dybh)
% dyhm: 单元编号
% jdzb: 单元上层节点的物理坐标
% jdzb1: 单元下层节点的物理坐标
% dybh: en
...
eki=zeros(40);ek=zeros(40);
for ii = 1:length(layers)
    d = layers{ii}.Q;
    z_1 = layers{ii}.z1; z_0 = layers{ii}.z0;
    bt = 2*z_1/t; at = 2*z_0/t;
